...
INSERT INTO `especificaciones` VALUES (1,'Fabaceae leguminosae.','Puede alcanzar entre 25 y 50 metros.','Hasta 3 metros en especímenes muy viejos.','Ancha y extendida creando una sombra considerable, las ramas son gruesas y robustas.','Suave, grisásea o marrón claro con fisuras un poco profundas.'),(2,'Salicaceae.','Puede alcanzar hasta 20 metros.','Hasta un metro.','Amplia y colgante con ramas largas y delgadas que caen hacia el suelo.','Es de color marrón grisaseo, se vuelve rugosa y fisurada con la edad.'),(3,'Bignoniaceae.','Puede alcanzar hasta los 30 metros.','Hasta un metro.','Ancha y redondeada con ramas extendidas.','Grisásea, se vuelve áspera y fisurada con la edad.'),(4,'Malvaceae.','Puede alcanzar hasta los 70 metros.','Hasta 3 metros o más.','Ancha y extendida con ramas que forman una gran sombrilla.','Lisa y grisásea en árboles jóvenes, con espinas cónicas, se vuelve más robusta con la edad.'),(5,'Rosaceae.','Puede alcanzar entre 4 a 10 metros.','Hasta 30 centímetros.','Redondeada y extendida.','Grisásea y rugosa en árboles maduros.'),(6,'Fabaceae.','Puede alcanzar entre 5 a 18 metros.','Hasta un metro.','Ancha y extendida con ramas que pueden tener espinas.','Grisásea a marrón, lisa en árboles jóvenes, se vuelve rugosa con la edad.'),(7,'Fabaceae.','Puede alcanzar entre 5 a 12 metros.','Hasta 60 centímetros.','Ancha y extendida con forma de sombrilla.','Grisásea y lisa, se vuelve más rugosa con la edad.'),(8,'Moraceae','Puede alcanzar entre 2 a 30 metros dependiendo sí es cultivada en exterior o interior.','Hasta un metro en condiciones óptimas.','Densa y extendida con ramas colgantes.','Gris clara y lisa.');
...
INSERT INTO `habitat` VALUES (1,'América central, desde México hasta Costa Rica.','Climas tropicales y subtropicales.','De 0 hasta 1200 metros sobre el nivel del mar.','Tolera una variedad de suelos aunque prefiere suelos bien drenados.'),(2,'Originario del centro y sur de China.','Prefiere climas templados y húmedos.','De 0 hasta 1000 metros sobre el nivel del mar.','Prefiere suelos húmedos, bien drenados y ricos en materia orgánica.'),(3,'Zonas tropicales en todo el mundo.','Prefiere climas tropicales y subtropicales.','De 0 hasta 1200 metros sobre el nivel del mar.','Prefiere suelos bien drenados ricos en nutrientes y con buenan humedad.'),(4,'De México a Sur América.','Prefieren climas tropicales.','De 0 hasta 1500 metros sobre el nivel del mar.','Prefieren suelos profundos, bien drenados y ricos en nutrientes.'),(5,'Europa mediterránea y América, especialmente en Chile.','Prefieren climas mediterráneos con inviernos suaves y veranos calurosos.','De 0 hasta 1000 metros sobre el nivel del mar.','Prefieren suelos bien drenados, ligeros y arenosos.'),(6,'Cerca del Oceano Pacífico y a trevés de toda América central.','Prefieren climas cálidos y secos.','De 0 hasta 1800 metros sobre el nivel del mar.','Prefieren suelos pobres, bien drenados, arenosos o arcillosos.'),(7,'Es endémico de Madagascar.','Prefiere climas húmedos y cálidos.','De 0 hasta 1200 metros sobre el nivel del mar.','Prefieren suelos bien drenados, arenosos o arcillosos ricos en materia orgánica.'),(8,'Se encuentra en América del sur.','Prefieren climas húmedos y cálidos.','De 0 hasta 1500 metros sobre el nivel del mar.','Prefieren suelos bien drenados ricos en materia orgánica.');
